...
package com.qdong.communal.library.widget.TimePicker.timePicker.view;
...
import com.qdong.communal.library.widget.TimePicker.timePicker.adapter.WheelViewAdapter;
import com.qdong.communal.library.widget.TimePicker.timePicker.controller.ItemsRange;
import com.qdong.communal.library.widget.TimePicker.timePicker.controller.WheelRecycle;
import com.qdong.communal.library.widget.TimePicker.timePicker.controller.WheelScroller;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xefE9E9E9,
			0xcfE9E9E9, 0x2fE9E9E9 };
/*	private int[] SHADOWS_COLORS = new int[] {0xFF585858,
			0xFF585858, 0xFF585858 };*/
	...
	private View getItemView(int index) {
		...
		index %= count;
	   View view= viewAdapter.getItem(index, recycle.getItem(), itemsLayout,(index==currentItem)?true:false);
